...
/* FOV of the CURRENT sensor crop, measured acoustically (2026-07-23):
 * a broadband source at two known pixels fit tan-scale 1.77x over the
 * RPi-v2 62.2deg-lens assumption => this module carries a WIDE lens
 * (~94deg full-width). For the 2560x1920 crop: HFOV 80.0, VFOV 64.4
 * (square pixels: tanV = tanH * 1920/2560). Keep in sync with the crop
 * window in app_camera_imx219.c or every marker/heatmap lands wrong. */
