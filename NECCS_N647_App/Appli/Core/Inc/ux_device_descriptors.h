...
/* ST VID + the MSC example PID: MSC uses inbox class drivers everywhere,
 * the IDs are identity only. Strings are ours. */
#define USBD_VID                                      1155
#define USBD_PID                                      22304
#define USBD_LANGID_STRING                            1033
#define USBD_MANUFACTURER_STRING                      "NECCS"
#define USBD_PRODUCT_STRING                           "NECCS Acoustic Imager"
#define USBD_SERIAL_NUMBER                            "NECCS0000001"
