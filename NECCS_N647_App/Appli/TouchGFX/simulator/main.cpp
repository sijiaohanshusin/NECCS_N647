...
// Stub implementation of VideoController for full source simulator projects.
// Read more about the VideoController on support.touchgfx.com
#include <touchgfx/hal/VideoController.hpp>
#include "video/DummyVideoController.hpp"
DummyVideoController controller;

touchgfx::VideoController& touchgfx::VideoController::getInstance()
{
    return controller;
}
