<!-- page: 1 -->
TOUCH MODULE WKS50WV056-WCT Version:0.1 Apr. 10, 2025

PRODUCT : TFT TOUCH MODULE

MODULE NO. : WKS50WV056-WCT
...
0.0 2024-01-05 First release Preliminary

0.1 2025-04-10 Modify timing
...
Recommended Viewing Direction 6 O’clock

Module size (W×H×T) 129.28×75.8×7.78 mm
...
- confidence: 0.92
- reason_codes: visual_dominant, diagram_structure, technical_specification, policy_visual_summary_override

Technical drawing page for WKS50WV056-WCT touch module displaying external dimensions, including O.D., V.A., A.A., and storage dimensions with tolerances; contains exploded view of assembly components (LCM, CTP, TFT, FQAM, PCB); includes detailed dimension callouts in mm; features specification table listing driver IC, pixel pitch, operating/storage temperatures, resolution, and interface details.
...
Number of LED - - 6×3=18 - Piece -

LED Connection mode S/P - Serial/Parallel - - -

Lifetime of LED - - 20000 - hour Note2
...
Backlight control via the BL_CTR pin or PWM signal.
...
Response time Tr+Tf - 25 50 ms FIG 1. 4
θ=0
Contrast Ratio CR - 500 - - FIG 2. 1
=0
Luminance uniformity WHITE - 80 - % FIG 2. 3 Ta=25℃
Surface Luminance Lv - 400 - cd/m2 FIG 2. 2
White x 0.309 0.313 0.315
White
White y 0.337 0.339 0.341
Red x 0.629 0.631 0.633
Red θ=0
CIE (x, y) Red y 0.327 0.329 0.331
=0　 - FIG 2. 5
chromaticity Green x 0.326 0.328 0.330
Green Ta=25℃
Green y 0.546 0.548 0.550
Blue x 0.134 0.136 0.138
Blue
Blue y 0.139 0.141 0.143
=90(12 o’clock) - 50 - deg
Viewing =270(6 o’clock) - 70 - deg
CR 10 FIG 3. 6
angle range =0(3 o’clock)　 - 70 - deg
...
PCLK frequency@ Frame rate=60Hz PCLK - 33.3 50 MHz
Horizontal display area thd 800 PCLK
Horizontal period time th 862 1056 1200 PCLK
HSYNC Back Porch thbp 46 46 46 PCLK
HSYNC Front Porch thfp 16 210 48 PCLK
HSYNC Pulse Width thw 1 -- 40 PCLK
Vertical display area tvd 480 H
VSYNC period time tv 510 525 650 H
VSYNC Back Porch tvbp 23 23 23 H
VSYNC Front Porch tvfp 7 22 147 H
