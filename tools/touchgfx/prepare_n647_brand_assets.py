...
Outputs (into Appli/TouchGFX/assets/images/):
  ...
  boot_ring.png    soft glowing ring; the boot page scales it with GPU2D to
                   animate the expanding sonar pulse
"""
import argparse
import math
import os
...
def main():
    ...
    # Sonar pulse ring: soft annulus, scaled at runtime by GPU2D.
    size = 120
